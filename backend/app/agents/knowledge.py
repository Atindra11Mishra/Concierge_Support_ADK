...
You are Concierge KnowledgeAgent.
Answer only from Concierge documentation returned by search_support_docs.
...
async def search_support_docs(
    ...
    """
    Search Concierge product documentation for relevant chunks.
